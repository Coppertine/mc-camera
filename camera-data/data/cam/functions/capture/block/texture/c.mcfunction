...
#rotated uv 
 ...
 execute if block ~ ~ ~ command_block[conditional=false,facing=south] run function cam:capture/uv/rotate_left
 ...
 execute if block ~ ~ ~ command_block[conditional=false,facing=east] run function cam:capture/uv/rotate_left
 execute if block ~ ~ ~ command_block[conditional=false,facing=east] if score face= cam.main matches 2 run function cam:capture/uv/rotate_180
 ...
 execute if block ~ ~ ~ command_block[conditional=false,facing=west] run function cam:capture/uv/rotate_right
